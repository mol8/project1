		...
		<form
			...
			<div class="form-group">
				<label for="surename">Apellidos</label> <input name="surename"
					class="form-control" value="${user.getSurename()}" />
			</div>
			<div class="form-group">
				<label for="idpatient">Identificador</label> <input name="idpatient"
					class="form-control" value="${patient.getIdpatient()}" />
			</div>
			<div class="form-group">
				<label for="username">Nombre de usuario</label> <input
					name="username" class="form-control" value="${user.getUsername()}" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="password">Password</label> <input name="password"
					class="form-control" type="password" value="${user.getPassword()}" />
			</div>
			<div class="form-group">
