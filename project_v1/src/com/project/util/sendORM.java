...
public class sendORM {
	...
	public sendORM(int localPort, boolean useTLS, int remotePort, String remoteIP) {
		super();
	...
	public void send(ORM_O01 orm_message) throws HL7Exception, LLPException, IOException, InterruptedException{
